/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 53fa0a159b1259953e05dafbc705102e)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	COFFRE: "hostinger";
	GUICHET_MEDIAS: "https://medias.dronezvous.com/guichet-medias.php";
	NEXT_PUBLIC_BASE_MEDIAS: "https://medias.dronezvous.com";
	BASE: "hyperdrive";
	DATABASE_URI: string;
	NEXT_PUBLIC_URL_SITE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COFFRE" | "GUICHET_MEDIAS" | "NEXT_PUBLIC_BASE_MEDIAS" | "BASE" | "DATABASE_URI" | "NEXT_PUBLIC_URL_SITE" | "CLE_CHIFFREMENT">> {}
}
